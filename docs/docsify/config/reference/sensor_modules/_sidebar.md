...
- Configuration
  ...
  - Section Reference
    ...
    - [sensor_modules](config/reference/sensor_modules/)
        - [- *](config/reference/sensor_modules/?id=sensor_modules-star)
        - [- name](config/reference/sensor_modules/?id=sensor_modules-star-name)
        - [- module](config/reference/sensor_modules/?id=sensor_modules-star-module)
        - [- cleanup](config/reference/sensor_modules/?id=sensor_modules-star-cleanup)
